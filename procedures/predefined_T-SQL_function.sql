--Task Description:
/*Create a MSTV function that returns the balance status for each account for a specific account number. The status for balance less than $1000 is categorized as low. 
