/* 1. Calculate the total balance for each customer across all their accounts */
...
/* 2. Find the customer who have less than $2000 in accounts and have more than
$5000 loan*/
...
/* 3. Find customers who don't have loans*/
...
/* 4. Find customer who have loan account, and have a transaction greater than the
...
/* 5. List the customer id that have both 'chequing' and 'savings' account*/
